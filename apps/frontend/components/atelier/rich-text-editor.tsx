...
import { RichTextToolbar } from '../atelier/rich-text-toolbar';
import { LinkDialog } from '../atelier/link-dialog';
 ...
 *
 * Atelier-styled WYSIWYG editor with formatting toolbar.
  ...
  if (!isMounted) {
    return (
      <div className={cn('space-y-1', className)}>
        <div className="h-9 rounded-[var(--radius-at-md)] border border-[var(--border)] bg-[var(--secondary)] p-1" />
        <div
          className={cn(
            'w-full rounded-[var(--radius-at-md)] border border-[var(--border)] bg-[var(--card)]',
    ...
    <div className={cn('space-y-1', className)}>
      ...
      <div
        className={cn(
          ...
          'focus-within:border-[var(--ring)] focus-within:ring-2 focus-within:ring-[var(--ring)]/20',
