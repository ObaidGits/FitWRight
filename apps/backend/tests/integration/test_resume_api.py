...
SAMPLE_INTERVIEW_PREP = {
    ...
    "project_follow_ups": [
        {
            "question": "What tradeoffs did you make in the project on your resume?",
...
class TestGenerateInterviewPrep:
    ...
    async def test_success_saves_structured_json(
        ...
        # update_resume is now scoped: args = (user_id, resume_id, updates).
        update_payload = mock_db.update_resume.await_args.args[2]
