...
> **Canonical source for agent behavior rules in FitWright.**

## What This Repo Is

FitWright is an AI-powered application that helps users tailor resumes to job descriptions. It consists of:
